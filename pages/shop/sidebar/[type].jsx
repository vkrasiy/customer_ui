...
import { useProductController } from '~/server/useProductController';

function ShopGrid() {
    const router = useRouter();
    const type = router.query.type;
    const query = router.query;
    //const data =  useProductController({link: "https://localhost:5000/goods/zara"});
    ...
    useEffect( async() => {
        // getProducts( await useProductController({link: "https://localhost:5000/goods/zara"}));
        getProducts( {
            variables: {
    ...
    useEffect( () => {
        if ( getProducts ) setFirstLoading( true );
    }, [ getProducts ] )
